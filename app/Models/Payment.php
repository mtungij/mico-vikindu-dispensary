...
#[Fillable(['facility_id', 'patient_id', 'visit_id', 'invoice_id', 'cashier_session_id', 'payment_number', 'payment_method_id', 'amount', 'currency', 'transaction_reference', 'idempotency_key', 'payer_name', 'payer_phone', 'bank_name', 'card_last_four', 'payment_date', 'status', 'received_by', 'confirmed_by', 'confirmed_at', 'reversed_at', 'reversed_by', 'reversal_reason', 'notes', 'metadata'])]
class Payment extends Model
{
    ...
    {
        return ['amount' => 'decimal:2', 'payment_date' => 'datetime', 'confirmed_at' => 'datetime', 'reversed_at' => 'datetime', 'metadata' => 'array'];
    }
