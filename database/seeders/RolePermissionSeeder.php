...
class RolePermissionSeeder extends Seeder
{
    ...
    private function map(): array
    {
        return [
            ...
            'receptionist' => ['dashboard.', 'patients.view', 'patients.create', 'patients.update', 'patients.manage-payers', 'patients.manage-documents', 'patients.print-card', 'reception.', 'workflow.manage-reception-queue', 'workflow.transfer-patient', 'workflow.print-ticket', 'invoices.view', 'invoices.create', 'billing.access', 'billing.view-queue', 'billing.view-invoice', 'observation.access', 'observation.view-bed-board', 'dental.access', 'dental.view-queue'],
            'cashier' => ['dashboard.', 'patients.view', 'invoices.view', 'billing.access', 'billing.view-', 'billing.receive-', 'billing.confirm-payment', 'billing.reprint-receipt', 'billing.print-invoice', 'billing.reports.view', 'cashier.sessions.', 'workflow.manage-billing-queue', 'observation.view-billing', 'dental.view-billing'],
            ...
            'dentist' => ['dashboard.', 'patients.view', 'workflow.manage-dental-queue', 'dental.', 'prescriptions.view', 'prescriptions.create', 'appointments.create', 'referrals.create'],
            'rch-nurse' => ['dashboard.', 'workflow.manage-rch-queue', 'rch.'],
