...
@php
    ...
    $navGroups = [
        ...
        'Fedha' => [
            ['label' => 'Billing', 'icon' => 'receipt', 'route' => 'coming-soon', 'enabled' => false],
            ['label' => 'Uhasibu', 'icon' => 'wallet-cards', 'route' => 'coming-soon', 'enabled' => false],
            ['label' => 'Bima na Madai', 'icon' => 'shield-check', 'route' => 'coming-soon', 'enabled' => false],
        ],
        'Utawala' => [
            ...
            ['label' => 'Dental Setup', 'icon' => 'file-signature', 'route' => 'settings.dental.findings', 'active' => 'settings.dental.*', 'enabled' => $user?->can('dental.manage-odontogram') ?? false],
