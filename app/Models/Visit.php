...
#[Fillable(['facility_id', 'patient_id', 'visit_number', 'visit_type', 'payer_type', 'patient_payer_profile_id', 'destination_department_id', 'current_department_id', 'consultation_service_id', 'visit_status', 'priority', 'source', 'reason_for_visit', 'referral_source', 'referral_number', 'arrived_at', 'registered_at', 'checked_in_at', 'completed_at', 'cancelled_at', 'cancellation_reason', 'created_by', 'updated_by'])]
