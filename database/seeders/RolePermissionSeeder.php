...
{
    private const RECEPTION_DIRECT_LAB_PERMISSIONS = [
    ...
    public function run(): void
    {
        ...
        foreach ($this->map() as $roleName => $prefixes) {
            ...
            $permissions = collect($all)->filter(function (string $permission) use ($prefixes, $roleName): bool {
                if (in_array($permission, $this->exclusions()[$roleName] ?? [], true)) {
                    return false;
                }
    ...
    private function map(): array
    {
        return [
            ...
            'receptionist' => ['dashboard.', 'patients.view', 'patients.create', 'patients.update', 'patients.manage-payers', 'patients.manage-documents', 'patients.print-card', 'reception.', 'workflow.manage-reception-queue', 'workflow.transfer-patient', 'workflow.print-ticket', 'invoices.view', 'invoices.create', 'billing.access', 'billing.view-queue', 'billing.view-invoice', ...self::RECEPTION_DIRECT_LAB_PERMISSIONS, 'laboratory-results.view', 'laboratory-results.print', 'laboratory-results.download', 'observation.access', 'observation.view-bed-board', 'dental.access', 'dental.view-queue', 'appointments.access', 'appointments.view-dashboard', 'appointments.view', 'appointments.view-calendar', 'appointments.create', 'appointments.update', 'appointments.cancel', 'appointments.reschedule', 'appointments.check-in', 'rch.access', 'rch.view-dashboard', 'rch.view-queue', 'rch.pregnancies.view', 'rch.family-planning.view', 'rch.children.view', 'rch.immunization.view', 'rch.appointments.'],
            ...
            'doctor' => ['dashboard.', 'patients.view', 'opd.', 'clinical-encounters.print', 'diagnoses.create', 'prescriptions.view', 'prescriptions.create', 'prescriptions.update', 'laboratory-orders.create', 'laboratory-orders.view', 'procedure-orders.view', 'procedure-orders.create', 'procedure-orders.cancel', 'workflow.manage-opd-queue', 'workflow.transfer-patient', 'workflow.emergency-override', 'laboratory-results.view', 'laboratory-results.release', 'laboratory-results.print', 'pharmacy.view-prescription', 'pharmacy.view-stock', 'bed-rest.admit', 'bed-rest.discharge', 'bed-rest.refer', 'observation.access', 'observation.view-', 'observation.admit', 'observation.create-order', 'observation.clinical-review', 'observation.discharge', 'observation.refer', 'observation.print-', 'appointments.access', 'appointments.view-dashboard', 'appointments.view', 'appointments.view-calendar', 'appointments.create', 'appointments.update', 'appointments.reschedule', 'appointments.check-in', 'appointments.manage-doctor-schedules', 'rch.access', 'rch.view-dashboard', 'rch.view-queue', 'rch.start-encounter', 'rch.complete-encounter', 'rch.view-history', 'rch.pregnancies.', 'rch.anc.', 'rch.family-planning.view', 'rch.children.view', 'rch.growth.view', 'rch.immunization.view', 'rch.reports.view'],
            'clinical-officer' => ['dashboard.', 'patients.view', 'opd.', 'clinical-encounters.print', 'diagnoses.create', 'prescriptions.view', 'prescriptions.create', 'prescriptions.update', 'laboratory-orders.create', 'laboratory-orders.view', 'procedure-orders.view', 'procedure-orders.create', 'procedure-orders.cancel', 'laboratory-results.view', 'laboratory-results.release', 'laboratory-results.print', 'pharmacy.view-prescription', 'pharmacy.view-stock', 'observation.access', 'observation.view-', 'observation.admit', 'observation.create-order', 'observation.clinical-review', 'observation.discharge', 'rch.access', 'rch.view-dashboard', 'rch.view-queue', 'rch.start-encounter', 'rch.complete-encounter', 'rch.pregnancies.view', 'rch.anc.view', 'rch.anc.record-visit', 'rch.children.view', 'rch.growth.view', 'rch.immunization.view'],
            ...
            'laboratory-technician' => ['dashboard.', 'workflow.manage-laboratory-queue', 'laboratory.', 'laboratory-orders.view', 'laboratory-results.', 'laboratory-critical-results.', 'laboratory-outsourced-tests.', 'laboratory-reports.'],
