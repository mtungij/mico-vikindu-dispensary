...
class RolePermissionSeeder extends Seeder
{
    ...
    private function map(): array
    {
        return [
            ...
            'receptionist' => ['dashboard.', 'patients.view', 'patients.create', 'patients.update', 'patients.manage-payers', 'patients.manage-documents', 'patients.print-card', 'reception.', 'workflow.manage-reception-queue', 'workflow.transfer-patient', 'workflow.print-ticket', 'invoices.view', 'invoices.create', 'billing.access', 'observation.access', 'observation.view-bed-board', 'dental.access', 'dental.view-queue'],
            'cashier' => ['dashboard.', 'patients.view', 'invoices.view', 'billing.access', 'billing.create-invoice', 'billing.receive-payment', 'workflow.manage-billing-queue', 'observation.view-billing', 'dental.view-billing'],
