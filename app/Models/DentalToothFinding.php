...
#[Fillable(['facility_id','dental_tooth_record_id','dental_encounter_id','finding_type_id','surface','surfaces','severity','finding_status','description','diagnosed_by','diagnosed_at','resolved_at','supersedes_finding_id','created_by','updated_by'])]
class DentalToothFinding extends Model
{
    use HasFactory, SoftDeletes;
    protected function casts(): array { return ['surface'=>ToothSurface::class,'surfaces'=>'array','finding_status'=>DentalFindingStatus::class,'diagnosed_at'=>'datetime','resolved_at'=>'datetime']; }
