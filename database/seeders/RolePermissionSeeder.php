...
class RolePermissionSeeder extends Seeder
{
    ...
    private function map(): array
    {
        return [
            ...
            'receptionist' => ['dashboard.', 'patients.view', 'patients.create', 'patients.update', 'patients.manage-payers', 'patients.manage-documents', 'patients.print-card', 'reception.', 'workflow.manage-reception-queue', 'workflow.transfer-patient', 'workflow.print-ticket', 'invoices.view', 'invoices.create', 'billing.access', 'billing.view-queue', 'billing.view-invoice', 'laboratory-orders.create-direct', 'laboratory-tests.view', 'laboratory-results.view', 'laboratory-results.print', 'laboratory-results.download', 'observation.access', 'observation.view-bed-board', 'dental.access', 'dental.view-queue', 'appointments.access', 'appointments.view-dashboard', 'appointments.view', 'appointments.view-calendar', 'appointments.create', 'appointments.update', 'appointments.cancel', 'appointments.reschedule', 'appointments.check-in', 'rch.access', 'rch.view-dashboard', 'rch.view-queue', 'rch.pregnancies.view', 'rch.family-planning.view', 'rch.children.view', 'rch.immunization.view', 'rch.appointments.'],
