...
class Invoice extends Model
{
    ...
    {
        return $this->hasMany(VisitPaymentHandoff::class);
    }

    public function patientPayerProfile(): BelongsTo
    {
        return $this->belongsTo(PatientPayerProfile::class);
    }
